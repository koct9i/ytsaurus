...
TEST(TSecureEnvironmentTest, MoveEnv)
{
    ...
    MoveEnvToSecureEnvironment(std::vector<TStringBuf>{"YT_SECURE_TEST_MISSING"});
    ...
    MoveEnvToSecureEnvironment(std::vector<TStringBuf>{"YT_SECURE_TEST_EXACT"}, std::vector<TStringBuf>{"YT_SECURE_TEST_PREFIX_"});
