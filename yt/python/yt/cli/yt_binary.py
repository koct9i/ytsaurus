...
def add_show_default_config_parser(add_parser):
    ...
    parser.add_argument("--with-env-patch", action="store_true", default=False, dest="with_env_patch", help="with patch from environment variables")
