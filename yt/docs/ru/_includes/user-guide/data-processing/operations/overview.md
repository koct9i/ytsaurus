...
Цельный сценарий мониторинга (выполнение, финальный результат, архивные запросы, метрики и логи) описан в разделе [Мониторинг операций](../../../../user-guide/data-processing/operations/monitoring.md).
